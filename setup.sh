...
#install xray
<<<<<<< HEAD
wget https://raw.githubusercontent.com/juangustavvo/juangustavvo/pvt/main/xray/ins-xray.sh && chmod +x ins-xray.sh && sed -i -e 's/\r$//' ins-xray.sh && screen -S xray ./ins-xray.sh
=======
